                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <div class="form-check-inline">
                                        <input {{ ($job->status == 0) ? 'checked' : '' }} class="form-check-input" type="radio" value="0" id="status-active" name="status">
                                        <label class="form-check-label" for="status">
                                            Block <!--if job is blocked it will not show on the frontend-->
                                        </label>
                                    </div>
                                </div>
                            </div>
