                                    ...
                                    @if($savedJobs->isNotEmpty())
                                        ...
                                        <tr class="active">
                                            ...
                                            <td>
                                                ...
                                                <div class="job-status text-capitalize">ofline</div>
                                            ...
                                            <td>
                                                <div class="action-dots float-end">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item" href="#" onclick="removeSavedJobs({{ $savedJob->id }})"><i class="fa fa-trash" aria-hidden="true"></i>Remove</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
